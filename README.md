...
An official implementation code for paper "[Transferable adversarial attack on image tampering localization](./)". This repo provide codes, pretrained/trained weights, and our training datasets.
